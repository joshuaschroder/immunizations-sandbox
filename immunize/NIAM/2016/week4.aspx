...
<p>Between August 22nd and 26th NIAM is raising awareness about the vaccines preteens and teens need for their future.</p>
<br/>
...
<table>
	<tr>
		<td style="width:33%;">
			...
			<p><a class="CTAButton" title="Find a TVFC Provider" href="/immunize/tvfc/info-for-parents.aspx">Find a TVFC Provider</a></p>
		</td>		
		<td style="width:33%;">
			<h2>Recommended Vaccines Give Maximum Protection</h2>
			<div style="font-size:0.9em; margin:12px 0;"><strong>Getting Ready for Your Future Starts with Staying Healthy</strong></div>
			<p>Teens and adolescents need three important vaccines (HPV, Tdap, and Meningitis) to protect themselves from potentially deadly diseases. </p>
			<p><a class="CTAButton" title="Learn More About Preteen Vaccines" href="/immunize/PreteenVaccines.aspx">Learn More About Preteen Vaccines</a></p>
		</td>
		<td style="width:33%;">
			<h2>Finally, All Your Immunizations Records in One Place</h2>
			<div style="font-size:0.9em; margin:12px 0;"><strong>ImmTrac Is Used by Schools to Verify Immunizations</strong></div>
			<p>ImmTrac, the Texas Immunization Registry, keeps your records all in one place and allows authorized organizations to verify immunizations.</p>
			<p><a class="CTAButton" title="Learn More About ImmTrac" href="/immunize/ImmTrac/">Learn About ImmTrac</a></p>	
		</td>		
	</tr>
</table>
...
<table>
	<tr>
		<td style="width:49%;padding-right:2%;">
			<h2>College Age Kids Can Use ImmTrac Too</h2>
			<div style="font-size:0.9em; margin:0 0 12px 0;"><strong>ImmTrac Now Stores Records up to Age 26</strong></div>
			<p>You have patients going into college. You need those immunization records that Mom may not have. Let your patients know that ImmTrac is there for them.</p>
			<p><a class="CTAButton" title="Register for ImmTrac" href="/immunize/immtrac/Authorized-Organizations.shtm">Register for ImmTrac</a></p>	
		</td>
		<td style="width:49%;">

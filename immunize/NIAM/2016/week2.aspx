...
<p>Between August 8th and 12th NIAM is raising awareness of the protection given to pregnant women by both the Tdap and the flu vaccine.</p>
<br/>
...
<table>
	<tr>
		<td style="width:33%;">
			<h2>Vaccines Prevent Childhood Diseases and Illness</h2>
			<div style="font-size:0.9em; margin:12px 0;"><strong>Don't Let Cost Prevent Vaccinations</strong></div>
			<p>The Texas Vaccines for Children (TVFC) program provides low-cost vaccines to infants and children under 18 who don't have health insurance as well as those enrolled in Medicaid or CHIP.</p>
			<p><a class="CTAButton" title="Learn More About TVFC" href="/immunize/tvfc/tvfc_about.shtm">Learn More About TVFC</a></p>			
		</td>
		<td style="width:33%;">
			<h2>Tdap and Flu Protect Two During Pregnancy</h2>
			<div style="font-size:0.9em; margin:12px 0;"><strong>Give Your Child Protection from Birth</strong></div>
			<p>By getting the Tdap and Flu vaccines during pregnancy, you give your child protection for up to six months of life, until they can get the vaccine themselves. </p>
			<p><a class="CTAButton" title="Vaccines for Pregnant Women" href="http://www.cdc.gov/vaccines/pregnancy/pregnant-women/index.html">Vaccines for Pregnant Women</a></p>
		</td>		
		<td style="width:33%;">
			<h2>Surround Your Baby with Protection</h2>
			<div style="font-size:0.9em; margin:12px 0;"><strong>Get Family Members Vaccinated Too</strong></div>
			<p>Babies can get diseases from even healthy-seeming people. Ensure everyone around your new little one has the Tdap, flu, and other necessary vaccines.</p>
			<p><a class="CTAButton" title="Surround Babies with Protection" href="http://www.cdc.gov/pertussis/pregnant/mom/protection.html">Surround Babies with Protection</a></p>			
		</td>
	</tr>
</table>
...
<table>
	<tr>
		<td style="width:49%;padding-right:2%;">
			<h2>Immunizing Adults Helps to Protect Infants Too</h2>
			<div style="font-size:0.9em; margin:0 0 12px 0;"><strong>Herd Immunity is Everyone's Responsibility</strong></div>
			<p>Encourage your adult clients to cocoon with Tdap vaccines. The Adult Safety Net Program can help to reach uninsured adults who may not otherwise consider vaccination.</p>
			<p><a class="CTAButton" title="Become an ASN Provider" href="/immunize/ASN/Providers.shtm">Become an ASN Provider</a></p>	
		</td>
		<td style="width:49%;">
			<h2>Are You a Medicaid or CHIP Provider?</h2>
			<div style="font-size:0.9em; margin:0 0 12px 0;"><strong>TVFC Can Help Prevent Many Childhood Diseases</strong></div>
			<p>The Texas Vaccines for Children (TVFC) Program provides no-cost immunizations to uninsured children who may not otherwise have access to vaccines.</p>
			<p><a class="CTAButton" title="Learn More About TVFC" href="/immunize/TVFC/">Learn More About TVFC</a></p>			
		</td>
	</tr>
</table>
...
<table>
	<tbody>
		...
		<tr>
			<td><img src="/uploadedImages/Content/Prevention_and_Preparedness/immunize/niam/2016/protect2-thumb-150.jpg" alt="Protect 2 From the Flu Poster" title="Protect 2 From the Flu Poster" style="height: 150px; width: auto;" /><br /><br /></td>

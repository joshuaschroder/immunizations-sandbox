...
<p style="padding-bottom:15px;">National Immunization Awareness Month is an annual observance every August to highlight the importance of immunizations for the health of children and adults. It is a celebration of the many successes of vaccines, and also a reminder that there are still many vaccine-preventable diseases to get protected against.</p>
<p>Between August 15th and 19th NIAM is working to make sure that children from birth to age six are given the right vaccines at the appropriate times to give them the most protection possible.</p>
<br/>
<div style="font-size:1.2em; clear:both;">News for the Public:</div>
<hr/>
<table>
	<tr>
		<td style="width:49%;padding-right:2%;">
			<h2>Finally, All Your Immunizations Records <br/>Are in One Place</h2>
			<div style="font-size:0.9em; margin:0 0 12px 0;"><strong>ImmTrac Is Used by Schools, Doctors' Offices and Child-Care Facilities to Verify Immunizations</strong></div>
			<p>ImmTrac, the Texas Immunization Registry, keeps up to date records for you, all in one place, and allows authorized organizations to verify immunizations. </p>
			<p><a class="CTAButton" title="Enroll in ImmTrac" href="http://www.immtracforeveryone.com">Learn More About ImmTrac</a></p>			
		</td>
		<td style="width:49%">
			<h2>Low-Cost Immunizations Now Available for Uninsured Children</h2>
			<div style="font-size:0.9em; margin:0 0 12px 0;"><strong>No Health Insurance?<br/>We've Got You Covered.</strong></div>
			<p>Uninsured and underinsured children may be eligible for low-cost immunizations through the Texas Vaccines for Children (TVFC) program. </p>
			<p><a class="CTAButton" title="Learn More About TVFC" href="/immunize/TVFC/tvfc_about.shtm">Learn More About TVFC</a></p>	
		</td>
	</tr>
</table>
...
<table>
	<tr>
		<td style="width:33%;">
			<h2>Implement Cocooning Strategies in Your Practice</h2>
			<div style="font-size:0.9em; margin:12px 0;"><strong>Help Protect Infants by Encouraging Adult Immunizations</strong></div>
			<p>The Adult Safety Net (ASN) Program provides no-cost vaccines to uninsured adults who may spread disease and illnesses to infants who may be more succeptable to illnesses like pertussis or influenza.</p>
			<p><a class="CTAButton" title="Learn More About ASN" href="http://www.dshs.texas.gov/ASN">Learn More About ASN</a></p>			
		</td>	
		<td style="width:33%;">
			<h2>Remove Barriers to Childhood Immunizations</h2>
			<div style="font-size:0.9em; margin:12px 0;"><strong>Remove Cost. Immunize More Patients.</strong></div>
			<p>The Texas Vaccines for Children (TVFC) Program offers no-cost vaccines to providers who serve uninsured and underinsured children. Now, there's no reason for children to miss out on immunizations.</p>
			<p><a class="CTAButton" title="Become a TVFC Provider" href="/immunize/TVFC/">Become a TVFC Provider</a></p>			
		</td>
		<td style="width:33%;">
			<h2>Stop Over/Under Vaccinating Patients</h2>
			<div style="font-size:0.9em; margin:12px 0;"><strong>ImmTrac Records All Childhood Vaccines in Texas</strong></div>
			<p>ImmTrac, the Texas Immunization Registry, consolidates vaccination records, even if they were administered by multiple providers. Now you can quickly and easily access the immunization status of any child.</p>
			<p><a class="CTAButton" title="Learn More About ImmTrac" href="/immunize/ImmTrac">Learn More About ImmTrac</a></p>
		</td>		
	</tr>
</table>
...
<table style="width:100%;">
	<tr>
		<td style="width:67%;">
			<h2>Add the 2016 NIAM Logo to Your Email Signature Block</h2>
			<p>Show your support of the 2016 Observance and help raise awareness by adding the NIAM logo to your email signature block.</p>
			<p>See the detailed instructions for the most popular email clients, including Outlook, iOS, and Gmail.</p>
			<p><a class="CTAButton" title="Add to My Email" href="/immunize/NIAM/2016/email-signatures.aspx">Add to My Email</a></p>			
		</td>		
		<td style="width:33%;text-align:center;">
			<img src="/uploadedImages/Content/Prevention_and_Preparedness/immunize/niam/2016/niam-logo-sm.jpg" alt="National Immunization Awareness Month 2016" title="National Immunization Awareness Month 2016" />
		</td>
	</tr>
	</table>
	...
	<p>If you are looking for resources to promote the observance, please see the <a title="CDC and NPHIC National Immunization Awareness Month toolkit" href="https://www.nphic.org/niam">CDC and NPHIC National Immunization Awareness Month toolkit</a>.</p>
	
	<br/>
	<h3>Printable Posters for Your Office</h3>
	<p>If you are looking for resources to promote immunizations in general, please see the <a title="Immunize Texas Order Form" href="http://immunizetexasorderform.com/">Immunize Texas Order Form</a> from the Texas Department of State Health Services. We have great brochures, posters, and more for you or your group to use. A sampling is below.</p>
<table>
	<tbody>
		<tr>
			<td><img src="/uploadedImages/Content/Prevention_and_Preparedness/immunize/niam/2016/halt-hpv.jpg" alt="Halt HPV Brochure" title="Halt HPV Brochure" style="height: 150px; width: auto;" /><br /><br /></td>
			<td><p><b>Halt HPV Brochure</b></p>
				<ul>
					<li><a title="Halt HPV Brochure - English" href="/immunize/docs/11-13711.pdf">Halt HPV Brochure - English (PDF)</a></li>
					<li><a title="Halt HPV Brochure - Spanish" href="/immunize/docs/11-13711A.pdf">Halt HPV Brochure - Spanish (PDF)</a></li>
					<li><a title="Halt HPV Brochure - Bilingual" href="/immunize/docs/11-13711P.pdf">Halt HPV Brochure - Bilingual</a> <span class="small">(PDF, 2.2MB)</span></li>
				</ul>
			</td>
		</tr>
		<tr>
			<td><img src="/uploadedImages/Content/Prevention_and_Preparedness/immunize/niam/2016/protect2-thumb.png" alt="Protect 2 From the Flu Poster" title="Protect 2 From the Flu Poster" style="height: 150px; width: auto;" /><br /><br /></td>
			<td><p><b>Protect 2 From the Flu Poster</b></p>
				<ul>
					<li><a title="Protect 2 Poster - African American" href="/immunize/docs/11-13645P-2.pdf">Protect 2 Poster - African American - English (PDF)</a></li>
					<li><a title="Protect 2 Poster - Anglo" href="/immunize/docs/11-13645P.pdf">Protect 2 Poster - Anglo - English (PDF)</a></li>
					<li><a title="Protect 2 Poster - Latino" href="/immunize/docs/11-13645PA.pdf">Protect 2 Poster - Latino - Spanish (PDF)</a></li>
				</ul>
			</td>
		</tr>
		<tr>
			<td><img src="/uploadedImages/Content/Prevention_and_Preparedness/immunize/niam/2016/meningococcal-brochure.jpg" alt="Meningitis Brochure" title="Meningitis Brochure" style="height: 150px; width: auto;" /><br /><br /></td>
			<td><p><b>Meningitis Brochure</b></p>
				<ul>
					<li><a title="Meningitis Brochure - English" href="/immunize/docs/11-13711.pdf">Meningitis Brochure - English (PDF)</a></li>
					<li><a title="Meningitis Brochure - Spanish" href="/immunize/docs/11-13712a.pdf">Meningitis Brochure - Spanish (PDF)</a></li>
				</ul>
			</td>
		</tr>
	</tbody>

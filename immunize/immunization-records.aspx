<?php
	$title= "Requesting Immunization Records for a Child or Adult" ;
	include '/home/codio/workspace/includes/header.html';
    include '/home/codio/workspace/includes/menus/imm_menu.html'; 
?>

<hr/>
<h2>Obtaining Records from Your Healthcare Provider</h2>
<p>If you need proof of immunization, the best place to start is by contacting the clinic, doctor, or healthcare provider that administered the vaccination. If your provider has the record on file, <em>this will be the fastest way of obtaining your records</em>.</p>
...
<p>If you are unable to obtain the records from your school or healthcare provider, your records <em><strong>may</strong></em> be stored in ImmTrac, the Texas Immunization Registry.</p>
<p>In 1999, ImmTrac was established as an "opt-in" registry for children’s records only, meaning parents/guardians who wanted their children’s immunization records stored in Texas’ Registry had to sign a consent form.</p>
<p>Only doctors, schools, child-care centers, public healthcare providers, and other authorized healthcare organizations may directly access ImmTrac. <strong><em>Immunization records are NOT available to view online by the general public, including parents or legal guardians</em></strong>.</p>
...
<p>Please allow 10-14 business days for delivery of your immunization records from the time of submitting your ImmTrac request. During the time period of Back-to-School (August-September), the timeframe is approximately 8-10 weeks.</p>

<hr/>
<h2>Futher Help and Questions</h2>
<p>For futher help, please refer to our <a title="ImmTrac FAQs page" href="https://www.dshs.texas.gov/immunize/immtrac/FAQs.shtm">ImmTrac FAQs page</a>.</p>
<p>If you still have questions, please contact us by email at <a title="ImmTrac@dshs.texas.gov" href="mailto:ImmTrac@dshs.texas.gov">ImmTrac@dshs.texas.gov</a>, or call (800) 252-9152.</p>
